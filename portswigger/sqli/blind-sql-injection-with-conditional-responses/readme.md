...
1. <b>Intercept the Request</b>  
Use Burp Suite Proxy to intercept a standard GET request and send it to the Repeater tab for manual manipulation.
...
![Screenshot of finding the password length](image-2.png)
...
![Screenshot of script result](image-3.png)
